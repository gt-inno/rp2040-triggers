...
#define SETTINGS_V3_RESERVED_BYTES (FLASH_PAGE_SIZE - SETTINGS_HEADER_BYTES - SETTINGS_V3_CHANNEL_BYTES - SETTINGS_CLOCK_BYTES)
...
typedef struct {
    ...
    uint32_t size;
    uint32_t crc32;
    settings_channel_record_v3_t channels[TRIGGER_CHANNEL_COUNT];
    uint32_t system_clock_khz;
    uint8_t reserved[SETTINGS_V3_RESERVED_BYTES];
